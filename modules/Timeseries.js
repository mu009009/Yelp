...
//			tooltipEnter.append('circle').attr('class','tool-tip-circle').attr('r',2).attr("fill","#c41200");
//			tooltipEnter.append('text').attr('class','tool-tip-text').attr('text-anchor','middle').attr('dy',-5).style("fill","#c41200");
//
