...
//	console.log(Business);
	...
	var WidthPx = null;
	var HeightPX = null;
	var PieSvg = d3.select("#canvas-1")
	.append('svg')
	.attr('class','svg')
	.attr('id','PIeChartSvg')
	.style('width',function()
	{
		WidthPx = document.getElementById('canvas-1').offsetWidth;
		return WidthPx + 'px';
	})
	.style('height',function()
	{
		HeightPX = document.getElementById('canvas-1').offsetHeight*0.5;
		return HeightPX + 'px';
	});
	...
	var Xposition = document.getElementById('canvas-1').offsetWidth*0.5;
...
//                return "rgb(" + "(255," + "255," + (255*(i%80*0.1)).toString()+")" ;
			...
			{
				Xposition = document.getElementById('canvas-1').offsetWidth*0.6;
